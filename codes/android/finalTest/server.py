...
def notify_android(ip, message):
    url = f"http://{ip}:8080/notify"  # 동적으로 IP 주소를 URL에 삽입(안드로이드 기기의 ip주소)
                ...
                try:
                    if weight_data.startswith("Weight: "):
                        ...
                        if current_weight >= target_weight:
                            print("목표 무게에 도달했습니다.")
                            notify_android("192.168.4.4", "물을 다 따랐습니다.") #안드로이드 기기의 ip주소
    ...
    try:
        ...
        if file:
            ...
            if labels:
                ...
                server_url = "http://52.78.208.162/getjson.php"#DB주소
